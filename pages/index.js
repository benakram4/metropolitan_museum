  ...
  return (
    <>
      ...
      <main>
        <Row>
          <Col className='mb-4'>
            <Image alt='Metropolitan Museum of Art' src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" fluid rounded />
          </Col>
        </Row>
        <Row>
          <Col md={6}>
          ...
          <Col className='text-center mt-5'>
            <p>
              For more information visit the Metropolitan Museum of Art <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">Wikipedia Page</a>.
            </p>
          </Col>
        </Row>
      </main>
